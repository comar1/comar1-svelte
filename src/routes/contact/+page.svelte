        ...
        <div class="bg-white w-[90%] md:w-[30rem] h-[full] my-8 p-8 -pb-3 mx-auto rounded-md ">
			...
			<form on:submit={submitForm} method="POST" class="flex flex-col space-y-3" use:enhance>
				...
				<!-- <div class="flex flex-col md:flex-row">
					<label>Message:</label>
					<textarea id="message" name="message" required class="bg-slate-100 h-[3rem] pt-3 pl-5 rounded-md"></textarea>
				</div> -->
				<div class="flex flex-col  mt-4">
					...
					<div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 mt-3">
						...
						<div class="px-4 py-2 bg-white rounded-b-lg border-red ">
							<textarea bind:value={form.message} id="editor" rows="8" class="block w-full px-4 text-sm text-gray-800 border-0 bg-white focus:ring-0" placeholder="Write an article..." required ></textarea>
						</div>
					</div>
				</div>	
				<button type="submit" class="bg-blue-900 text-white w-[40%] h-[3rem] mx-auto rounded-md opacity-90 hover:opacity-100">Send</button>
			   </form>
        </div>
    </div>
