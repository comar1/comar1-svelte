...
<div
	class="pt-5 md:pt-[8rem] w-[80%] md:w-[40%] lg:w-[28rem] h-full space-y-5 sticky mx-auto md:relative md:-left-[2%] mb-5 scroll-smooth"
	id="about"
>
	<p>
		...
		privilege of building software for an advertising agency, a start-up, a huge corporation, and a
		digital product studio.
	</p>

	<p>
		My main focus these days is building accessible user interfaces for our customers at Klaviyo. I
		most enjoy building software in the sweet spot where design and engineering meet — things that
