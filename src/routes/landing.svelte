	...
	<div class="flex flex-row justify-center mt-[3rem] space-x-7 md:space-x-4 md:justify-start">
		<a href="https://www.linkedin.com/in/comar1/" class="hover:underline"
			><svg
				...
				class="w-7 h-7 align-middle opacity-75 hover:opacity-100"
				id="linkedin"
				viewBox="0 0 448 512"
			...
			></a
		>
		<a href="https://github.com/comar1" class="hover:underline"
			><svg
				xmlns="http://www.w3.org/2000/svg"
				class="w-7 h-7 align-middle opacity-75 hover:opacity-100"
				id="github"
			...
			></a
		>
		<a href="https://www.instagram.com/comarjoshua/" class="hover:underline"
			><svg
				xmlns="http://www.w3.org/2000/svg"
				class="w-7 h-7 align-middle opacity-75 hover:opacity-100"
				id="instagram"
			...
			></a
		>
		<a href="https://twitter.com/notc0mar" class="hover:underline"
			><svg
				xmlns="http://www.w3.org/2000/svg"
				class="w-7 h-7 align-middle opacity-75 hover:opacity-100"
				id="twitter"
